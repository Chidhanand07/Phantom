...
Revision ID: 5dc2548767c4
Revises: 
Create Date: 2026-04-26 06:00:27.026979
...
def upgrade() -> None:
    ...
    op.create_index('ix_agent_logs_cycle_at', 'agent_logs', ['cycle_at'], unique=False)
    ...
    sa.Column('thesis_status', sa.String(), server_default='active', nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('ix_trade_memories_stock_thesis_status', 'trade_memories', ['stock', 'thesis_status'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_trade_memories_stock_thesis_status', table_name='trade_memories')
    op.drop_table('trade_memories')
    op.drop_table('positions')
    op.drop_table('portfolio')
    op.drop_index('ix_agent_logs_cycle_at', table_name='agent_logs')
